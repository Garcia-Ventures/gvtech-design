...
function Marker({
  ...
  asChild = false,
  ...props
}: React.ComponentProps<'div'> & VariantProps<typeof markerVariants> & MarkerBaseProps) {
...
function MarkerIcon({ className, ...props }: React.ComponentProps<'span'> & MarkerIconBaseProps) {
  return (
    <span
...
function MarkerContent({ className, ...props }: React.ComponentProps<'span'> & MarkerContentBaseProps) {
  return (
    <span
...
export type ___verifyMarkerContract = React.ComponentProps<typeof Marker> extends MarkerBaseProps ? true : false;
