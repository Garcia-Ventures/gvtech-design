...
function Questionnaire({
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Root> & QuestionnaireBaseProps) {
  return (
...
function QuestionnaireProgress({
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Progress> & QuestionnaireProgressBaseProps) {
  return (
...
function QuestionnaireItem({
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Item> & QuestionnaireItemBaseProps) {
  return (
...
function QuestionnaireTitle({
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Title> & QuestionnaireTitleBaseProps) {
  return (
...
function QuestionnaireDescription({
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Description> & QuestionnaireDescriptionBaseProps) {
  return (
...
function QuestionnaireChoices({
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Choices> & QuestionnaireChoicesBaseProps) {
  return (
...
function QuestionnaireChoice({
  ...
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Choice> & QuestionnaireChoiceBaseProps) {
  return (
...
function QuestionnaireChoiceDescription({
  className,
  ...props
}: React.ComponentProps<'span'> & QuestionnaireChoiceDescriptionBaseProps) {
  return (
...
function QuestionnaireInput({
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Input> & QuestionnaireInputBaseProps) {
  return (
...
function QuestionnaireError({
  className,
  ...props
}: React.ComponentProps<typeof QuestionnairePrimitive.Error> & QuestionnaireErrorBaseProps) {
  return (
...
function QuestionnaireActions({ className, ...props }: React.ComponentProps<'div'> & QuestionnaireActionsBaseProps) {
  return (
    <div
...
// Verify that the components satisfy the ui-core contracts
export type ___verifyQuestionnaireContract =
  React.ComponentProps<typeof Questionnaire> extends QuestionnaireBaseProps ? true : false;
