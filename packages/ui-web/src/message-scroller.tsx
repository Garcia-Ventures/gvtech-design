...
function MessageScroller({
  className,
  ...props
}: React.ComponentProps<typeof MessageScrollerPrimitive.Root> & MessageScrollerBaseProps) {
  return (
...
function MessageScrollerViewport({
  className,
  ...props
}: React.ComponentProps<typeof MessageScrollerPrimitive.Viewport> & MessageScrollerViewportBaseProps) {
  return (
...
function MessageScrollerContent({
  className,
  ...props
}: React.ComponentProps<typeof MessageScrollerPrimitive.Content> & MessageScrollerContentBaseProps) {
  return (
...
function MessageScrollerItem({
  ...
  scrollAnchor = false,
  ...props
}: React.ComponentProps<typeof MessageScrollerPrimitive.Item> & MessageScrollerItemBaseProps) {
  return (
...
export type ___verifyMessageScrollerContract =
  React.ComponentProps<typeof MessageScroller> extends MessageScrollerBaseProps ? true : false;
