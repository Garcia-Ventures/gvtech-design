...
const componentStatuses: ComponentStatusItem[] = [
  ...
  { name: 'Kbd', href: 'kbd', category: 'Components', web: 'implemented', native: 'implemented', flutter: 'planned' },
  ...
  { name: 'Select', href: 'select', category: 'Forms', web: 'implemented', native: 'implemented', flutter: 'planned' },
  {
    name: 'Separator',
    href: 'separator',
    category: 'Layout',
